     ...
     <div className='!mb-10 flex flex-col align-center md:items-start justify-center  items-center '>
      ...
      <div className='flex flex-wrap   gap-12 xl:gap-5 md:!pr-15 items-center justify-center md:items-start md:justify-start lg:gap-5'>
          ...
          <Link href='/products/3'>
            ...
            <div className="flex items-center w-full justify-center "><del className="flex items-center text-zinc-400"><FaRupeeSign />43,135</del> &nbsp;&nbsp;&nbsp;&nbsp;<FaRupeeSign />36,999</div>
            </Link>
          </div>
          ...
          <Link href='/products/22'>
            ...
            <div className="flex items-center w-full justify-center "><del className="flex items-center text-zinc-400"><FaRupeeSign />34,81,763</del> &nbsp;&nbsp;&nbsp;&nbsp;<FaRupeeSign />26,78,999</div>
            </Link>
          </div>
          <div className=' p-4 rounded-2xl shadow-lg overflow-hidden hover:scale-105 hover:-translate-y-2 transition-all duration-500'>
          <Link href='/products/4'>
            ...
            <div className="flex items-center w-full justify-center "><del className="flex items-center text-zinc-400"><FaRupeeSign />9,86,869</del> &nbsp;&nbsp;&nbsp;&nbsp;<FaRupeeSign />7,06,999</div>
            </Link>
          </div>
