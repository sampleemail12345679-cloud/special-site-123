  ...
  return (
    <section className=' text-white md:h-50 h-100 w-full flex items-center justify-center !mt-10'>
      <div className='container mx-auto text-center  flex flex-col justify-center items-center gap-2 '>
        ...
        <div className='text-lg mb-8 max-w-2xl flex [@media(min-width:900px)]:text-nowrap  md:self-start md:!pl-10 w-screen xl:gap-24 md:gap-7 flex-col md:flex-row gap-7 items-center md:items-start '>
          ...
          />
          <button onClick={notify} className=' text-white rounded-lg font-semibold b2 w-[60vw] md:w-auto'>
            Subscribe
          </button>
